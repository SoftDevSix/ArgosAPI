...
//        assertNotNull(result.getMethodCoverageResults());
//        assertTrue(result.getMethodCoverageResults().isEmpty());
//    }
//
//    @Test
...
//                .build();
//
//        result.getMethodCoverageResults().add(methodCoverage);
//
//        assertEquals(1, result.getMethodCoverageResults().size());
//        assertEquals(methodCoverage, result.getMethodCoverageResults().get(0));
//    }
}
